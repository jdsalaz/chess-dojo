	...
	table := []struct {
		...
		},
		{
			...
			user: &User{
				...
				Ratings: map[RatingSystem]*Rating{
					Chesscom: {StartRating: 1500, CurrentRating: 1572},
					Lichess:  {StartRating: 1400, CurrentRating: 1472},
					Fide:     {StartRating: 1300, CurrentRating: 1372},
					Uscf:     {StartRating: 1200, CurrentRating: 1272},
				},
			},
			wantStart:   1500,
			wantCurrent: 1572,
